...
const TITLES: Record<string, { title: string; section: string; icon: IconType }> = {
  ...
  "/dashboard/storage-manager": { title: "Google Drive", section: "Storage", icon: GD },
  ...
  "/dashboard/dropbox": { title: "Dropbox", section: "Storage", icon: DBX },
  "/dashboard/onedrive": { title: "OneDrive", section: "Storage", icon: OD },
